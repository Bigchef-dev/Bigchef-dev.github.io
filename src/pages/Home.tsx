...
const socialLinks = [
  ...
  {
    name: 'LinkedIn',
    url: 'https://linkedin.com/in/mathieu',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: 'Instagram',
    url: 'https://instagram.com/mathieu',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  return (
    <section id="home" className="min-h-screen pt-20 flex items-center justify-center">
      <div className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        {/* Tagline */}
        <p className="text-lg text-gray-500 mb-6 max-w-xl mx-auto leading-relaxed -mt-6">
          {t('hero.tagline')}
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          <button
            ...
            className="px-6 py-3 bg-teal-600 text-white font-semibold rounded-lg hover:bg-teal-700 transition-all shadow-sm hover:shadow-md"
          >
            {t('hero.cta_projects')}
          </button>
          <a
        ...
        <div className="flex items-center justify-center gap-4">
          {socialLinks.map((link) => (
            <a
              ...
              className="p-2.5 border border-gray-200 rounded-lg text-gray-500 hover:text-teal-600 hover:border-teal-300 hover:bg-teal-50 transition-all"
